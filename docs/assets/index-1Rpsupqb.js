import{C as t,H as d,a as f,R as h,D as j,A as me,B as p,b as v,I as E,M as ge,S as ye,T as U,c as ve,u as fe,d as I,e as P}from"./tinywidgets-B5UvyxBw.js";import{r as g,R as e,a as ke}from"./react-dom-wpXbf5jk.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function c(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(a){if(a.ep)return;a.ep=!0;const r=c(a);fetch(a.href,r)}})();var we="bhdd6s0",be="bhdd6s1";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ce=g.forwardRef(({color:l="currentColor",size:n=24,strokeWidth:c=2,absoluteStrokeWidth:o,className:a="",children:r,iconNode:s,...y},F)=>g.createElement("svg",{ref:F,...Te,width:n,height:n,stroke:l,strokeWidth:o?Number(c)*24/Number(n):c,className:ie("lucide",a),...y},[...s.map(([L,q])=>g.createElement(L,q)),...Array.isArray(r)?r:[r]]));/**
 * @license lucide-react v0.446.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const w=m("SquareFunction",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}],["path",{d:"M9 17c2 0 2.8-1 2.8-2.8V10c0-2 1-3.3 3.2-3",key:"m1af9g"}],["path",{d:"M9 11.2h5.7",key:"3zgcl2"}]]);/**
 * @license lucide-react v0.446.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
const a: number = 1;
  \`}
  language="typescript"
/>`}),e.createElement("p",null,"This example shows the use of the ",e.createElement("code",null,"typescript")," language.")),e.createElement(t,{code:`
const a: number = 1;
...
</Card>`}),e.createElement("p",null,"This example shows one of the values within the ",e.createElement("code",null,"dimensions")," object, and then applies some of them to a custom component.")),e.createElement(v,null,e.createElement(t,{code:H.logo}),e.createElement(d,null),e.createElement("div",{style:{width:H.logo,height:H.logo,background:"oklch(50% 0.11 0)"}}))]]}),O];k["css/screens"]=["screens",()=>e.createElement(i,{type:"CSS",importLine:"import {screens} from 'tinywidgets/css';",title:"screens",comments:e.createElement(e.Fragment,null,e.createElement("p",null,"The ",e.createElement("code",null,"screens")," object contains the media query breakpoints that TinyWidget uses to distinguish small, medium, and large screens."),e.createElement("p",null,"Currently, the main impact of the ",e.createElement("code",null,"large")," member is that screens narrower than this number of pixels will get a collapsed side bar. Screens narrower than the ",e.createElement("code",null,"small")," number of pixels will get a slightly smaller font.")),icon:O,params:{},props:{},examples:[[e.createElement(e.Fragment,null,e.createElement(t,{code:"<Code code={JSON.stringify(screens, null, 2)} />"}),e.createElement("p",null,"This example gets the breakpoint values.")),e.createElement(t,{code:JSON.stringify(qe,null,2)})]]}),O];x["hook/useDark"]=["useDark",()=>e.createElement(i,{type:"HOOK",importLine:"import {useDark} from 'tinywidgets';",title:"useDark",comments:e.createElement(e.Fragment,null,e.createElement("p",null,"The useDark hook returns whether the user is viewing the application in dark mode.")),icon:w,params:{},props:{},examples:[[e.createElement(e.Fragment,null,e.createElement(t,{code:`<Card>
  Currently in {useDark() ? 'dark' : 'light'} mode
</Card>`}),e.createElement("p",null,"This example shows the hook returning the current mode.")),e.createElement(v,null,"Currently in ",fe()?"dark":"light"," mode")]]}),w];x["hook/useRoute"]=["useRoute",()=>e.createElement(i,{type:"HOOK",importLine:"import {useRoute} from 'tinywidgets';",title:"useRoute",comments:e.createElement(e.Fragment,null,e.createElement("p",null,"The useRoute hook returns the current route, assuming the app is using the basic TinyWidgets routing system."),e.createElement("p",null,"This 'system' simply involves using this hook to get a string which may have been persisted to the hash part of the browser's URL.")),icon:w,params:{},props:{},examples:[[e.createElement(e.Fragment,null,e.createElement(t,{code:`<Card>
  Current route
  <Hr />
  <code>{useRoute()}</code>
</Card>`}),e.createElement("p",null,"This example shows the hook returning the current route.")),e.createElement(v,null,"Current route",e.createElement(d,null),e.createElement("code",null,I()))]]}),w];x["hook/useSetRouteCallback"]=["useSetRouteCallback",()=>{const l=P();return e.createElement(i,{type:"HOOK",importLine:"import {useSetRouteCallback} from 'tinywidgets';",title:"useSetRouteCallback",comments:e.createElement(e.Fragment,null,e.createElement("p",null,"The useSetRouteCallback hook a callback for setting the current route, assuming the app is using the basic TinyWidgets routing system."),e.createElement("p",null,"This 'system' simply involves using this hook to set a string to be persisted to the hash part of the browser's URL.")),icon:w,params:{},props:{},examples:[[e.createElement(e.Fragment,null,e.createElement(t,{code:`const setRoute = useSetRouteCallback();
// ...
<Button
  icon={Lucide.Home}
  title="Home"
  onClick={() => setRoute('home')}
/>`}),e.createElement("p",null,"This example shows the hook returning a callback that will change the current route when called as a click handler.")),e.createElement(p,{icon:se,title:"Home",onClick:()=>l("home")})]]})},w];Object.assign(b,u,x,M,k,D);var He="_1u9ishf0",We="_1u9ishf1",ae="_1u9ishf2",re="_1u9ishf3",C="_1u9ishf4",oe="_1u9ishf5";const A=({route:l,variant:n="item",current:c,className:o})=>{var s,y;const a=P(),r=g.useCallback(()=>a(l),[a,l]);return e.createElement(p,{variant:n,title:(s=b[l])==null?void 0:s[0],icon:(y=b[l])==null?void 0:y[2],onClick:r,className:o,current:c})},de=()=>e.createElement("div",{className:He},e.createElement("div",{className:ae},e.createElement("h1",{className:We},e.createElement(E,{src:"/favicon.svg",variant:"logo",className:C}),"TinyWidgets"),e.createElement("p",null,"A collection of tiny, reusable, React components, all optionally wrapped up in a helpful app layout, with header, side bar, and dark mode.")),e.createElement(d,{className:oe}),e.createElement(h,null,e.createElement(v,null,e.createElement("h2",null,"Components"),Object.keys(u).sort().map((l,n)=>e.createElement(A,{route:l,variant:"default",key:n,className:re}))),e.createElement(v,null,e.createElement("h2",null,"Hooks, Functions, & Objects"),Object.keys({...x,...M,...k,...D}).sort().map((l,n)=>e.createElement(A,{route:l,variant:"default",key:n,className:re})))),e.createElement(d,{className:oe}),e.createElement("div",{className:ae},e.createElement(E,{src:"https://upload.wikimedia.org/wikipedia/commons/a/a7/React-icon.svg",variant:"logo",className:C}),e.createElement(E,{src:"https://raw.githubusercontent.com/vanilla-extract-css/vanilla-extract/refs/heads/master/site/logo.svg",variant:"logo",className:C}),e.createElement(E,{src:"https://lucide.dev/logo.light.svg",variant:"logo",className:C}),e.createElement(E,{src:"https://tinybase.org/favicon.svg",variant:"logo",className:C}),e.createElement("p",null,"TinyWidgets uses ",e.createElement("a",{href:"https://react.dev/"},"React")," for DOM manipulation,"," ",e.createElement("a",{href:"https://vanilla-extract.style/"},"Vanilla-Extract")," for styling and theming, ",e.createElement("a",{href:"https://lucide.dev/"},"Lucide")," for icons, and ",e.createElement("a",{href:"https://tinybase.org"},"TinyBase")," for state management. Its philosophy is all about simplicity, decent defaults, a streamlined DOM, and concise styling."),e.createElement("p",null,"But, just to be clear - that doesn't mean ",e.createElement("i",null,"you")," need to use Vanilla-Extract, Lucide, or Tinybase in the apps you build with these widgets. You can set arbitrary class names (from Tailwind, for example!) on all components if you like."),e.createElement("p",null,"Of course, this site is itself a demo of TinyWidgets, showing off the components and layout in action. But check out the individual components by navigating the API documentation in the side bar.")));b.home=["Home",de,se];var he={exports:{}},_={};/**
 * @license React
 ...
 */var je=g,Be=Symbol.for("react.element"),Ie=Symbol.for("react.fragment"),Pe=Object.prototype.hasOwnProperty,De=je.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,ze={key:!0,ref:!0,__self:!0,__source:!0};function Ee(l,n,c){var o,a={},r=null,s=null;c!==void 0&&(r=""+c),n.key!==void 0&&(r=""+n.key),n.ref!==void 0&&(s=n.ref);for(o in n)Pe.call(n,o)&&!ze.hasOwnProperty(o)&&(a[o]=n[o]);if(l&&l.defaultProps)for(o in n=l.defaultProps,n)a[o]===void 0&&(a[o]=n[o]);return{$$typeof:Be,type:l,key:r,ref:s,props:a,_owner:De.current}}_.Fragment=Ie;_.jsx=Ee;_.jsxs=Ee;he.exports=_;var W=he.exports;const Ue="#181717",Ve=g.forwardRef(function({title:n="GitHub",color:c="currentColor",size:o=24,...a},r){return c==="default"&&(c=Ue),W.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:o,height:o,fill:c,viewBox:"0 0 24 24",ref:r,...a,children:[W.jsx("title",{children:n}),W.jsx("path",{d:"M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"})]})}),$e=()=>e.createElement(e.Fragment,null,e.createElement(pe,null,e.createElement(ue,null),"Installation"),e.createElement("p",null,"TinyWidgets works well with a Vite-based development and build environment, because then it's particularly easy to use Vanilla-Extract."),e.createElement(t,{code:`
$> npm install tinywidgets
        `}));b.installation=["Installation",$e,ue];const Ge=["home",null,"installation",null,["Components",Object.keys(u).sort(),!0],["Hooks & Functions",Object.keys({...x,...M}).sort()],["Objects",Object.keys({...D,...k}).sort()]],Je=()=>{const l=I()||"home";return Ge.map((n,c)=>{if(n instanceof Array){const[o,a,r]=n;return e.createElement(f,{title:o,id:o,startOpen:r,key:c},a.map((s,y)=>e.createElement(A,{route:s,current:l===s,key:y})))}else return n?e.createElement(A,{route:n,current:l===n,key:c}):e.createElement(d,{key:c})})},Ye=()=>e.createElement(me,{title:Ke,topNavRight:e.createElement(p,{title:"GitHub",icon:Ve,href:"https://github.com/tinyplex/tinywidgets"}),sideNav:Je,main:Ze}),Ke=()=>{const l=P(),n=g.useCallback(()=>l(""),[l]);return e.createElement("h1",{className:be,onClick:n},e.createElement(E,{src:"/favicon.svg",variant:"logo",alt:"TinyWidgets"}),"TinyWidgets")},Ze=()=>{var c;const l=I(),n=((c=b[l])==null?void 0:c[1])??de;return e.createElement("article",{className:we},e.createElement(n,null))};var B={},ce=ke;B.createRoot=ce.createRoot,B.hydrateRoot=ce.hydrateRoot;addEventListener("load",()=>B.createRoot(document.getElementById("app")).render(e.createElement(Ye,null)));
