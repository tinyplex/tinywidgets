...
import {breaks} from 'tinywidgets/css';
CSS_ROUTES['css/breaks'] = ['breaks', () => {
return (<Api 
  type='CSS'
  importLine="import {breaks} from 'tinywidgets/css';"
  title='breaks'
  comments={<><p>The <code>breaks</code> object contains the media query breakpoints that TinyWidget uses
to distinguish small, medium, and large screens.</p>
<p>Currently, the main impact of the <code>large</code> member is that screens narrower than this number of
pixels will get a collapsed side bar. Screens narrower than the <code>small</code> number of
pixels will get a slightly smaller font.</p>
</>}
  icon={Lucide.Ruler}
  params={{
}}
  ...
  examples={[
[<><Code code={`<Code code={JSON.stringify(breaks, null, 2)} />`} /><p>This example gets the breakpoint values.</p>
...
return (<Api 
  ...
  title='classNames'
  comments={<><p>The <code>classNames</code> function returns a concatenated list of class names, filtering
